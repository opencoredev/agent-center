...
repoConnectionRoutes.get("/", async (context) => {
  ...
  return runApiEffect(
    context,
    tryApiPromise(() => repoConnectionService.list(filters, userId)),
  );
});
...
repoConnectionRoutes.post("/", async (context) => {
  ...
  return runApiEffect(
    context,
    tryApiPromise(() => repoConnectionService.create(input, userId)),
    201,
  );
});
...
repoConnectionRoutes.post("/:repoConnectionId/test", async (context) => {
  ...
  return runApiEffect(
    context,
    tryApiPromise(() => repoConnectionService.test(repoConnectionId, userId)),
  );
});
...
repoConnectionRoutes.get("/:repoConnectionId", async (context) => {
  ...
  return runApiEffect(
    context,
    tryApiPromise(() => repoConnectionService.getById(repoConnectionId, userId)),
  );
});
...
repoConnectionRoutes.delete("/:repoConnectionId", async (context) => {
  ...
  return runApiEffect(
    context,
    tryApiPromise(() => repoConnectionService.delete(repoConnectionId, userId)),
  );
});
